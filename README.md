...
data/                  # 原始與中繼資料（公開倉庫僅保留報告）
  ...
  hk4tuc_route_official.kml   # 官方四徑 KML（存放於倉庫根目錄，make_map.py 所需）

scripts/               # 數據處理 Python 腳本
  scraper.py            # 抓取單年份 dottrack.asia API 數據
  multi_year.py         # 批次抓取 2021–2026 多年份選手數據
  make_map.py           # 生成 DNF 精確停止點地圖（使用 hk4tuc_route_official.kml）
```
...
*製作：@Jise2939 @Ray24200867 @www33888 ｜ 2026 年 3 月*
